...
data class SalesGetStateResponse(
    ...
    @SerializedName("coupons") var coupons: ArrayList<String>,
    @SerializedName("cardNumber") var cardNumber: Int = 0,
    @SerializedName("cardBrand") var cardBrand: String = "",
    @SerializedName("products") var products: ArrayList<Products> = arrayListOf()
) : Serializable {
    data class Products(
        @SerializedName("sku") var sku: Int = 0,
